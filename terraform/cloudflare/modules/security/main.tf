...
# NOTE: WAF skip rules disabled - using SSH tunnel for Authentik API access instead
# This avoids Cloudflare challenge issues and is more secure
# See: .github/actions/setup-authentik-tunnel
...
# DISABLED: Now using SSH tunnel (setup-authentik-tunnel) for API access
