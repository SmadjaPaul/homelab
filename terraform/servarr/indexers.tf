...
#     {
#       name            = "apiKey"
#       sensitive_value = data.doppler_secrets.servarr.map.NINJACENTRAL_API_KEY
#     },
#     {
#       name       = "vipExpiration"
...
#     {
#       name            = "apiKey"
#       sensitive_value = data.doppler_secrets.servarr.map.NZBGEEK_API_KEY
#     },
#     {
#       name       = "vipExpiration"
...
#     {
#       name            = "apiKey"
#       sensitive_value = data.doppler_secrets.servarr.map.ALTHUB_API_KEY
#     },
#     {
#       name       = "vipExpiration"
