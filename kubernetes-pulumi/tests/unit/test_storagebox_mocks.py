...
from shared.apps.common.storagebox import StorageBoxManager  # noqa: E402
from shared.utils.schemas import IdentityUserModel  # noqa: E402
...
class TestStorageBoxManager(unittest.TestCase):
    ...
    def test_storagebox_subaccount_creation(self):
        ...
        users = [
            IdentityUserModel(name="testuser", email="test@example.com", groups=[])
        ]
